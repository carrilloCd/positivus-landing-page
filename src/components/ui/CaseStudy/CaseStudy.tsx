...
export const CaseStudy: React.FC<ICaseStudyProps> = ({ description, url }) => {
  return (
    <div className='case-study'>
      <p className='case-study__description'>
        {description}
      </p>
      <a href={url} className='case-study__link'>
        <span className='case-study__link-text'>
          Learn more
        </span>
        <span className='case-study__link-icon'>
