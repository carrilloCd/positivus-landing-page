...
export const Link: React.FC<ILinkProps> = ({ text, url }) => {
  return (
    <a href={url} className='link link--primary'>
      {/* {textPosition === 'first' && <span className='link__text'>Learn More</span>} */}
      ...
      {/* {textPosition === 'last' && <span className='link__text'>{text}</span>} */}
    </a>
  )
}